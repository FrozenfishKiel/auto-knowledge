...
class EventDefinitions(BaseModel):
    ...
    AUTO_KNOWLEDGE_JOB_CREATED: EventDefinition = EventDefinition(
        name='auto_knowledge.job.created',
        description='An Auto Knowledge job was created.',
        message='Auto Knowledge job created',
    )
    AUTO_KNOWLEDGE_JOB_UPDATED: EventDefinition = EventDefinition(
        name='auto_knowledge.job.updated',
        description='An Auto Knowledge job was updated.',
        message='Auto Knowledge job updated',
    )
    AUTO_KNOWLEDGE_JOB_DELETED: EventDefinition = EventDefinition(
        name='auto_knowledge.job.deleted',
        description='An Auto Knowledge job was deleted.',
        message='Auto Knowledge job deleted',
    )
    AUTO_KNOWLEDGE_JOB_RUN_REQUESTED: EventDefinition = EventDefinition(
        name='auto_knowledge.job.run_requested',
        description='An Auto Knowledge job run was requested.',
        message='Auto Knowledge run requested',
    )
    AUTO_KNOWLEDGE_JOB_RUN_COMPLETED: EventDefinition = EventDefinition(
        name='auto_knowledge.job.run_completed',
        description='An Auto Knowledge job run completed.',
        message='Auto Knowledge run completed',
    )
    AUTO_KNOWLEDGE_JOB_RUN_FAILED: EventDefinition = EventDefinition(
        name='auto_knowledge.job.run_failed',
        description='An Auto Knowledge job run failed.',
        message='Auto Knowledge run failed',
    )
    AUTO_KNOWLEDGE_CANDIDATE_APPROVED: EventDefinition = EventDefinition(
        name='auto_knowledge.candidate.approved',
        description='An Auto Knowledge candidate was approved.',
        message='Auto Knowledge candidate approved',
    )
    AUTO_KNOWLEDGE_CANDIDATE_REJECTED: EventDefinition = EventDefinition(
        name='auto_knowledge.candidate.rejected',
        description='An Auto Knowledge candidate was rejected.',
        message='Auto Knowledge candidate rejected',
    )
    AUTO_KNOWLEDGE_CANDIDATE_PUBLISHED: EventDefinition = EventDefinition(
        name='auto_knowledge.candidate.published',
        description='An Auto Knowledge candidate was published.',
        message='Auto Knowledge candidate published',
    )
